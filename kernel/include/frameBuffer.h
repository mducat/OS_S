...
framebuffer_t *framebuffer_create_from_uint32_array(unsigned int width, unsigned int height, uint32_t *buf);
...
void my_xor_lines(framebuffer_t *buf, Vector2f_t *vects, int n);
void my_xor_line(framebuffer_t *buf, Vector2f_t vects0, Vector2f_t vects1);
void my_put_xor_pixel_fast(framebuffer_t *framebuffer, unsigned int x, unsigned int y);
