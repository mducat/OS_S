...
//
// NOTE: Per Section 3 of the GNU Lesser General Public License version 3.0,
// since this Application uses only numerical parameters and structures from the
// elf.h header file, the Application does not need to be covered under the GPL.
//
// See the GNU Lesser General Public License version 3.0 (which is also
...
// Commented out since we only need definitions (Jan. 7, 2018)
//#include <features.h>
